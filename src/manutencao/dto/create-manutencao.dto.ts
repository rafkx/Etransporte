...
export class CreateManutencaoDto {
    ...
    @ValidateIf( o => (o.itemManutencaoPeca && o.itemManutencaoPeca.length > 0) || (o.itemManutencaoServico && o.ItemManutencaoServico.length > 0))
    itensPeca: ItemManutencaoPeca[];

    @ValidateIf( o => (o.itemManutencaoServico && o.ItemManutencaoServico.length > 0) || (o.itemManutencaoPeca && o.itemManutencaoPeca.length > 0))
