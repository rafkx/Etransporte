...
export class Funcionario extends BaseEntity {
    ...
    @Column({ name: 'dataNasciFun', type: 'varchar', length: 50 })
    dataNasciFun: string;
    ...
    @Column({ name: 'numero', type: 'varchar', nullable: true, length: 50 })
    numero?: string;
    ...
    @Column({ name: 'dataAdmissao', type: 'varchar', length: 100})
    dataAdmissao: string;
