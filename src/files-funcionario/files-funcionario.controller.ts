...
export class FilesFuncionarioController {
  constructor(private readonly filesFuncionarioService: FilesFuncionarioService) {}
  ...
  handelUpload(
    ...
    @Req() req: Request): Promise<FilesFuncionario[]> {
      return this.filesFuncionarioService.salvarDados(files['file'], createFileFuncionarioDto, req);
    }
